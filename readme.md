...
🔴 Note: To ensure the environment runs properly, you need to use an Anaconda or Miniconda environment. Both Windows and Linux support the operation of scATD.
